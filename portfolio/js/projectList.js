...
myProjects = [
    ...
    },
    {
        ...
        ranking: 2,
        body: '<p>I wrote my own mapping, "dictionary", or hash-table in Python. It uses open-addressing to resolve hash collisions (I\'ve also implemented a chaining version, but this one is cleaner). Has allProjects of the basic features you\'d expect. Nerdy details include... </p><p>I overload the "in" operator by using the __contains__ method in my class, and implemented looping over keys, values, or items by using generators and the built-in yield statement. Table automatically resizes up at 70% occupancy to a 2x or larger prime value (for fewer hash collisions).</p>',
